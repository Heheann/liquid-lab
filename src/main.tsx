...
function App() {
  ...
  function startAnimationTimer() { setAnimating(true); const ms = data.settings.speed === 'slow' ? 3200 : data.settings.speed === 'fast' ? 2100 : 2700; window.setTimeout(() => void finishAnimation(), ms); }
